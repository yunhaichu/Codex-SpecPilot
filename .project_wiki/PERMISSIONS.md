...
- `wikiguard_self_development` — 开发 Codex WikiGuard 自身
- `supervised_project_development` — 被 WikiGuard 监督的普通项目

### wikiguard_self_development

用于开发 Codex WikiGuard 本身。
允许 Codex 修改：
- hooks/*.py
- .codex/hooks.json
- tests/*
